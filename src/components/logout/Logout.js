                    ...
                    {!profile && (
                        <div className="h-full w-full md:h-full md:w-full md:h-full md:w-full">
                            ...
                            <section className="flex flex-col">
                                ...
                                <div className="px-4">
                                <Link to="/" id="logout" className="flex items-center justify-center rounded-md bg-primary-200 text-primary-600 h-8 md:h-11 w-full md:w-3/4 mt-5 md:ml-8 hover:bg-white hover:text-primary-600">Logout from this account</Link>
                                </div>
                            </section>
                        </div>
                    )
