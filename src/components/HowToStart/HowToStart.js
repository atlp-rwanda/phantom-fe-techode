...
const HowToStart = () => {
  return (
    ...
    <div className='p-2.5 items-center'>
        <h1 className="text-2xl md:text-4xl font-bold text-blue-500 font-sans ">How to Get Started</h1>
    </div>

    <div className='flex flex-row flex-wrap justify-center justify-between items-center  md:mx-20 md:p-10 pt-10'>
