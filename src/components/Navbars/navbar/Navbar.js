  ...
  return (
    <div className="z-30 relative">
      <div className="max-w-7xl mx-auto flex items-center justify-between p-2.5">
        <div id="log" className="w-14 text-3xl font-bold text-blue-500 font-sans ">
        ...
        `}>
          <ul className="md:flex md:flex-row">
            <li className="list-none md:mr-5">
              <Link to="/" className="flex w-full text-blue-500 font-semibold hover:text-red-600 cursor-pointer pt-2.5 px-2.5">
                Home
              </Link>
            </li>
            <li>
              <Link to="/services" className="flex w-full text-blue-500 font-semibold hover:text-red-600 cursor-pointer pt-2.5 px-2.5">
                Services
              </Link>
            </li>
            <li>
              <Link to="/whoweare" className="flex w-full text-blue-500 font-semibold hover:text-red-600 cursor-pointer pt-2.5 px-2.5">
                Who we are
              </Link>
            </li>
            <li>
              <Link to="/login" className="flex w-full text-blue-500 font-semibold hover:text-red-600 cursor-pointer pt-2.5 px-2.5">
                Login
              </Link>
            </li>
          </ul>
