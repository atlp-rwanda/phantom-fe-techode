...
import { forgotPassword as Forgot } from "../../redux/actions/accountActions"
...
const mapStateToprops = (state) => {
    ...
    return { forgotPass: state.forgotPassword }
}
export default connect(mapStateToprops, { Forgot })(PasswordReset)
