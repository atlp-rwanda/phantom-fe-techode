...
const CardService = ({serviceTitle, serviceContent}) => {
  return (
    ...
    <div className="w-20 h-20 md:w-20 md:h-20 items-center justify-center rounded-full mx-auto bg-gray-400">
      <img src="" className='' />
    </div>
    <h1 className="text-xl md:text-2xl font-bold text-blue-500 font-sans ">
      {serviceTitle}
    </h1>
