        ...
        >
            <div className="lg:w-5/12 md:w-7/12 w-full h-full ">
               {signInSkeleton && (<SkeletonUpdate />)}
                 {!signInSkeleton && (
                     <>
                        <a className="text-mainColor" href="">
                             <span className="iconify w-8 h-9 absolute lg:-ml-56 md:-ml-48 lg:-mt-36 md:-mt-32 -ml-44 -mt-32" data-icon="akar-icons:arrow-left"></span>
                        </a>
                        <div className="w-full h-full letfSide_bg-color flex flex-col items-center justify-center ">
