                ...
                <div className="w-full letfSide_back-color h-screen py-10 px-1">
                    ...
                    <div className="text-primary m-6">
                        <div className="flex items-center mt-3 justify-center">
                            ...
                            <a href=""><span className="iconify w-8 h-9 absolute lg:-ml-56 md:-ml-48 lg:-mt-36 md:-mt-32 -ml-44 -mt-32" data-icon="akar-icons:arrow-left"></span></a>
                        </div>
                        <form onSubmit={formik.handleSubmit} className="md:w-full md:-ml-6">
                            ...
                            <p className="font-sans font-medium lg:ml-20 md:ml-6 justify-center text-blue-500"><a href="">Forget Password?</a></p>

                            <div className="flex items-center mt-6">
                                <button
                                    type="submit"
                                    className={
                                        "bg-blue-500 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded lg:ml-20 md:ml-6 lg:w-3/4 w-full"
                                    }
                                    value="Login">
                                    Login
                                </button>
